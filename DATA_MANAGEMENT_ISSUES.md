 ...
 This is likely the biggest “day-to-day work” product issue: engineers commonly have one ticket with several PRs, a worktree, and a tmux session. Radar needs a clearer rule for “one work item per ticket/workstream” vs “one task per
 PR”.
 ...
 That is probably fine for sessions, but less clear for workstreams. A user may expect “I deleted the workstream” to mean “this local work is finished/cleaned up”, while Radar treats it as no longer observable.
 ...
 2. Pick one canonical grouping rule: likely “ticket/workstream first, PRs/Jira/git/tmux as refs under it”.
